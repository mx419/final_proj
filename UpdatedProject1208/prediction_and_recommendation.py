...
def station_distance(station_id, station_dictionary):
	...
	# a human being typically walks 1 kilometers for 15 minutes.
	# 1 degree difference between latitude or longitude is 111 km.
	# so  
                ...
                for j in range(len(distance)):
                    if distance_sorted[i] == distance[j]:
                        ...
                        if prediction_result[0] == 1:
                            print 'the station name is' + str(station_dictionary.values()[j][0])
